        ...
        <div data-scroll-offset class="w-full max-w-2xl shadow-xl rounded-xl text-center">
          ...
          <div class="w-full p-4 bg-white rounded-xl">
            <?php if (!empty($results['link_gambar'])) : ?>
              ...
              <img src="<?= base_url() ?>img/standarLayanan/standarBiayaPelayanan/<?= $results['link_gambar'] ?>" alt="standarBiayaPelayanan" class="w-full h-full object-cover">
            <?php endif; ?>
...
<!-- Judul Halaman Standar Biaya Pelayanan -->
<section class="p-7 m-7 bg-base-100" data-scroll>
  <div class="text-black p-6 rounded-lg shadow-lg border-lg max-w-2xl mx-auto">
    <h2 class="text-2xl font-semibold mb-4 text-center">Standar Biaya Pelayanan</h2>
