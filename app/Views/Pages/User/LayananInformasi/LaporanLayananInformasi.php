...
<div class="flex flex-col mx-10">
  ...
  <section class="flex flex-col text-center" id="header-regulasi">
    <div class="text-2xl" data-scroll data-scroll-direction="vertical" data-scroll-speed="-2" data-scroll-position="top" data-scroll-target="#header-regulasi">Laporan Layanan Informasi</div>
    <div class="divider"></div>
  </section>

  <!-- Image & Content Section -->
  <section class="flex flex-col md:flex-row items-center justify-center my-20 h-full" id="fixed-elements" data-scroll>
