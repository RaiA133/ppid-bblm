...
<section class="flex justify-center items-center bg-stone-100 py-10 h-screen" id="header-home" data-scroll>
  ...
  <div class="max-w-md">
    ...
    <div class="flex justify-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 50px; height: 50px;">
    ...
    <h1 class="text-2xl mt-2 font-bold">Blank Page</h1>
  </div>
