<?php if (session()->getFlashdata('openModalAddDataInformasiSetiapSaatJudul')): ?>
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      document.getElementById('addDataInformasiSetiapSaatJudul').showModal();
    });
  </script>
<?php endif; ?>
...
<dialog id="addDataInformasiSetiapSaatJudul" class="modal">
  <div class="modal-box">
    <form method="dialog">
    ...
    <div class="py-4">
      ...
      <form action="<?= base_url() ?>/api/admin/informasi-setiap-saat/manage-judul/create" method="post">
