  ...
  <section class="container py-5 px-2 sm:px-5 md:px-7 mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
      ...
      <div class="my-2 flex justify-center w-full sm:w-fit">
        <?= $pager->links('informasi_setiap_saat_judul', 'daisyui_pagination'); ?>
      </div>
      ...
      <div class="flex items-center gap-2 flex-col sm:flex-row w-full sm:w-fit">
        ...
        <div class="w-[277px] sm:w-fit">
          <button class="btn px-4 sm:px-6 btn-sm normal-case btn-neutral text-neutral-content py-2 border w-full" onclick="addDataInformasiSetiapSaatJudul.showModal()">Add Data</button>
