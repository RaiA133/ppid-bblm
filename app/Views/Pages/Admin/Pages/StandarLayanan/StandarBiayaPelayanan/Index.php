                  ...
                  <?php if (!empty($results['content'])) : ?>
                    <div class="w-full max-w-2xl">
                      <div class="w-full py-8 px-10">
                        <article class="prose prose-sm prose-headings:text-indigo-500" id="content-preview-standar-biaya-layanan">
                          <?= $results['content'] ?>
                        </article>
...
<section class="relative mx-5 sm:mx-10 bg-base-100 shadow-lg rounded-lg p-4 sm:p-10 mb-5">
  ...
  <form id="myForm" action="<?= base_url() ?>/api/admin/standar-biaya-pelayanan/edit/<?= $results['id_standar_biaya_pelayanan'] ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex justify-between items-center w-full gap-3">
      <div class="text-md sm:text-xl font-bold">Edit Data Standar Biaya Pelayanan</div>
