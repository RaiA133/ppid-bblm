...
<!-- Preview Data -->
<section class="join join-vertical mx-5 sm:mx-10 mt-10 mb-5 rounded-lg shadow-md flex justify-center">
              ...
              <div class="h-fit sm:w-1/2 sm:max-w-[50vw]" data-scroll data-scroll-sticky data-scroll-target="#fixed-elements">
                <div class="card border w-full shadow-xl rounded-xl">
                  ...
                  <div class="py-5 pr-5 text-end self-end w-1/2">
                    <h2 class="text-xl text-indigo-500 font-extrabold">LAPORAN LAYANAN INFORMASI</h2>
                  </div>
                </div>
              </div>
                  ...
                  <?php if (!empty($results['content'])) : ?>
                    <div class="w-full max-w-2xl">
                      <div class="w-full py-8 px-10">
                        ...
                        <h2 class="text-xl text-indigo-500 font-extrabold mt-5 text-end">LAPORAN LAYANAN INFORMASI</h2>
                      </div>
                    </div>
