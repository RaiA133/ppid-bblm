                ...
                <div class="flex justify-center w-full">
                  <div id="customHeight" class="h-fit pb-20" data-scroll data-scroll-sticky data-scroll-target="#fixed-elements">
                    <div data-scroll-offset class="w-full max-w-2xl mt-20 shadow-xl rounded-xl">
                      <h2 class="text-2xl font-semibold mb-4 text-center">Laporan Layanan Informasi</h2>
                      <div class="w-full p-4 bg-white rounded-xl">
                        <img src="<?= base_url() ?>img/layananInformasi/laporanLayananInformasi/<?= $results['link_gambar'] ?>" alt="Laporan Layanan Informasi" class="w-full h-full object-cover">
                      </div>
                    </div>
                  </div>
...
<section class="mx-5 sm:mx-10 bg-base-100 shadow-lg rounded-lg p-10 mb-5">
  ...
  <form id="myForm" action="<?= base_url() ?>/api/admin/laporan-layanan-informasi/edit/<?= $results['id_laporan_layanan_informasi'] ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex justify-between items-center w-full">
      <div class="text-xl font-bold">Edit Data Laporan Layanan Informasi</div>
    ...
    <div class="flex flex-col xl:flex-row gap-4">
      ...
      <div class="w-full">
        ...
        <div class="flex gap-3 justify-center mb-3 flex-col">
          ...
          <?php endif ?>
          <textarea class="textarea textarea-bordered w-full" placeholder="LaporanLayananInformasi" name="content_edit" id="content">
          <?php if (!empty($results['content'])) : ?>
            <?= $results['content'] ?>
          <?php else : ?>
            <li class="text-xs">-</li>
