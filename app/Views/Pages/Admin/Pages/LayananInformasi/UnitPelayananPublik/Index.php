              ...
              <div id="customHeight" class="h-fit w-1/2 " data-scroll data-scroll-sticky data-scroll-target="#fixed-elements">
                <div class="card border w-full shadow-xl rounded-xl">
                  <figure class="px-4 pt-4">
                    <img
                      id="img-preview-admin-unitpelayananpublik-preview"
                  ...
                  <div class="py-5 pr-5 text-end self-end w-1/2">
                    <h2 class="text-xl text-indigo-500 font-extrabold">UNIT PELAYANAN PUBLIK</h2>
                  </div>
                </div>
              </div>
                  ...
                  <?php if (!empty($results['content'])) : ?>
                    <div class="w-full max-w-2xl">
                      <div class="w-full py-8 px-10">
                        <article class="prose prose-sm prose-headings:text-indigo-500" id="content-preview-unit-pelayanan-publik">
                          <?= $results['content'] ?>
                        </article>
                        <div class="divider"></div>
                        <h2 class="text-xl text-indigo-500 font-extrabold mt-5 text-end">UNIT PELAYANAN PUBLIK</h2>
                      </div>
                    </div>
...
<section class="relative mx-5 sm:mx-10 bg-base-100 shadow-lg rounded-lg p-4 sm:p-10 mb-5">
  ...
  <form id="myForm" action="<?= base_url() ?>/api/admin/unit-pelayanan-publik/edit/<?= $results['id_unit_pelayanan_publik'] ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="flex justify-between items-center w-full gap-3">
      <div class="text-md sm:text-xl font-bold">Edit Data Unit Pelayanan Publik</div>
    ...
    <div class="flex flex-col xl:flex-row gap-4">
      ...
      <div class="w-full">
          ...
          <div class="w-4/12">
            ...
            <script>
              function previewImgAdminUnitPelayananPublik() {
                ...
                const imgPreviewDropdown = document.querySelector('#img-preview-admin-unitpelayananpublik-preview');
        ...
        <div class="flex gap-3 justify-center mb-3 flex-col">
          ...
          <?php endif ?>
          <textarea class="textarea textarea-bordered w-full" placeholder="Unit Pelayanan Publik" name="content_edit" id="content">
          <?php if (!empty($results['content'])) : ?>
            <?= $results['content'] ?>
          <?php else : ?>
            <li class="text-xs">-</li>
